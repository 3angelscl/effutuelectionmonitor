      ...
      const popupContent = `
        <div style="min-width:180px;font-family:system-ui,sans-serif">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
            <span style="font-family:monospace;font-size:11px;font-weight:700;color:#4f46e5;background:#eef2ff;padding:2px 6px;border-radius:4px">${station.psCode}</span>
          ...
          <p style="font-size:13px;font-weight:600;color:#111827;margin:0 0 4px 0">${station.name}</p>
          ${station.location ? `<p style="font-size:11px;color:#6b7280;margin:0 0 6px 0">${station.location}</p>` : ''}
          <div style="border-top:1px solid #f3f4f6;padding-top:6px;margin-top:4px">
            <div style="display:flex;justify-content:space-between;font-size:11px;color:#6b7280">
              <span>Agent</span>
              <span style="font-weight:500;color:#374151">${station.agent ? station.agent.name : '<em style="color:#f97316">Unassigned</em>'}</span>
            </div>
